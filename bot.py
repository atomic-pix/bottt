...
async def die(ctx):
    responses = ['why have you brought my short life to an end', 'i could have done so much more', 'eh, dont wanna die rn']
    await ctx.send(choice(responses))

@client.command(name='credits', help='This command returns the credits')
async def credits(ctx):
    await ctx.send('Made by "BlackArch#3494"')
...
client.run('ODQzNzkzNzUzMTgxNTE5ODky.YKJCKw.ZF9VDXACY7aOJiCO5yiiuoe7cjg')
